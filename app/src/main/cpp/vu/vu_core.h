...
private:
    ...
    void vu_div(VU_State& vu, const VU_Instr& instr);
    void vu_sqrt(VU_State& vu, const VU_Instr& instr);
    void vu_rsqrt(VU_State& vu, const VU_Instr& instr);
    void vu_waitq(VU_State& vu, const VU_Instr& instr);
    void vu_rnext(VU_State& vu, const VU_Instr& instr);
    void vu_geti(VU_State& vu, const VU_Instr& instr);
    void vu_next(VU_State& vu, const VU_Instr& instr);
    void vu_ilwr(VU_State& vu, int vu_idx, const VU_Instr& instr);
    void vu_iswr(VU_State& vu, int vu_idx, const VU_Instr& instr);
    void vu_loi(VU_State& vu, const VU_Instr& instr);
    void vu_fcget(VU_State& vu, const VU_Instr& instr);
    void vu_fceq(VU_State& vu, const VU_Instr& instr);
    void vu_fcor(VU_State& vu, const VU_Instr& instr);
    void vu_fmeq(VU_State& vu, const VU_Instr& instr);
    void vu_fmfir(VU_State& vu, const VU_Instr& instr);
    void vu_fmor(VU_State& vu, const VU_Instr& instr);
    void vu_fmove(VU_State& vu, const VU_Instr& instr);
    void vu_fmul(VU_State& vu, const VU_Instr& instr);
    void vu_fmulq(VU_State& vu, const VU_Instr& instr);
    void vu_fmulai(VU_State& vu, const VU_Instr& instr);
    void vu_faddq(VU_State& vu, const VU_Instr& instr);
    void vu_fmaddq(VU_State& vu, const VU_Instr& instr);
    void vu_faddi(VU_State& vu, const VU_Instr& instr);
    void vu_faddai(VU_State& vu, const VU_Instr& instr);
    void vu_vaddq(VU_State& vu, const VU_Instr& instr);
    void vu_vaddai(VU_State& vu, const VU_Instr& instr);
    void vu_vsubai(VU_State& vu, const VU_Instr& instr);
    void vu_vaddaq(VU_State& vu, const VU_Instr& instr);
    void vu_vsubaq(VU_State& vu, const VU_Instr& instr);
    void vu_vmaddaq(VU_State& vu, const VU_Instr& instr);
    void vu_vmsubaq(VU_State& vu, const VU_Instr& instr);
    void vu_vadda(VU_State& vu, const VU_Instr& instr);
    void vu_vsuba(VU_State& vu, const VU_Instr& instr);
    void vu_vmadda(VU_State& vu, const VU_Instr& instr);
    void vu_vmsuba(VU_State& vu, const VU_Instr& instr);
    void vu_vitof0(VU_State& vu, const VU_Instr& instr);
    void vu_vitof4(VU_State& vu, const VU_Instr& instr);
    void vu_vitof12(VU_State& vu, const VU_Instr& instr);
    void vu_vitof15(VU_State& vu, const VU_Instr& instr);
    void vu_vftoi0(VU_State& vu, const VU_Instr& instr);
    void vu_vftoi4(VU_State& vu, const VU_Instr& instr);
    void vu_vftoi12(VU_State& vu, const VU_Instr& instr);
    void vu_vftoi15(VU_State& vu, const VU_Instr& instr);
    void vu_vadda_bc(VU_State& vu, const VU_Instr& instr);
    void vu_vsuba_bc(VU_State& vu, const VU_Instr& instr);
    void vu_vmadda_bc(VU_State& vu, const VU_Instr& instr);
    void vu_vmsuba_bc(VU_State& vu, const VU_Instr& instr);
    void vu_vadda_i(VU_State& vu, const VU_Instr& instr);
    void vu_vsuba_i(VU_State& vu, const VU_Instr& instr);
    void vu_vadda_q(VU_State& vu, const VU_Instr& instr);
    void vu_vsuba_q(VU_State& vu, const VU_Instr& instr);
    void vu_vaddax(VU_State& vu, const VU_Instr& instr);
    void vu_vadday(VU_State& vu, const VU_Instr& instr);
    void vu_vaddaz(VU_State& vu, const VU_Instr& instr);
    void vu_vaddaw(VU_State& vu, const VU_Instr& instr);
    void vu_vsubax(VU_State& vu, const VU_Instr& instr);
    void vu_vsubay(VU_State& vu, const VU_Instr& instr);
    void vu_vsubaz(VU_State& vu, const VU_Instr& instr);
    void vu_vsubaw(VU_State& vu, const VU_Instr& instr);
    void vu_vaddi(VU_State& vu, const VU_Instr& instr);
    void vu_vsubi(VU_State& vu, const VU_Instr& instr);
    void vu_vmaddi(VU_State& vu, const VU_Instr& instr);
    void vu_vmsubi(VU_State& vu, const VU_Instr& instr);
    void vu_vmaxbc(VU_State& vu, const VU_Instr& instr);
    void vu_vmini(VU_State& vu, const VU_Instr& instr);
    void vu_vmaxi(VU_State& vu, const VU_Instr& instr);
